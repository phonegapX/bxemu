...
class TestStrategy(StrategyTemplate):
    ...
    def onTick(self, tick):
        """收到行情TICK推送"""
        try:
            self.pm.placeOrder(DIRECTION_BUY, 5566.5, 100)
...
class BacktestBitMEXMarket(object):
    ...
    def run(self):  
        ...
        self.account.deposit(112769369) #给账户充值
        self.account.adjustLeverage(5)  #

        tupleQuote1 = (5465.82, 5566.50, datetime.now())
